...
//		Facebook IDs
		...
		String id[]={"_akshata_warad","vinutabadami_12","bagya_vc1999","varshakamble_23",
				"435tejuak_","984hanu","farin25#","xyz","subbu123","varshhh"};
		
		for(int i=0;i<id.length;i++) {
			
			System.out.println("Facebook ids are : "+id[i]);
			
		}
		
//		Password
		System.out.println();
		String password[]= {"1233","1jjcdhj","bchdbhxb","cvsdcdsf","gfteaguw","bdhefcHW",		
		                    "gdcgdui","hdscygyet","shdyeg","sgdyg"};
		
		for(int i=0; i<password.length;i++) {
			
			System.out.println("Password of each memeber is :"+password[i]);
			
		}
		
//		Home address
		System.out.println();
		String address[]= {"#33 ART nagar,hubli","#23 Sahadev nagar,old hubli","#22 Bharath nagar,hubli","#98 BTM Banglore","#45 xyz Keshwapur","#123 Gokul road,Airport,gokul",		
		                    "#234 Dollars colony,Hubli","#67 JP nagar ,Bengaluru","#89 SM layout,gadag","#09 KUD,Dharwad"};
		
		for(int i=0; i<address.length;i++) 
		{
			
			System.out.println("address each memeber is :"+address[i]);
		
	    }	
		
//		IFSC Code
		System.out.println();
		String code[]= {"SYNB24667","CAN676783","SBI7467782","CAN87845948","HDFC75857","SBI465656",		
		                    "SBI9806766","MHR6567687","ICIC6768909","SYN55343"};
		
		for(int i=0; i<code.length;i++) {
			
			System.out.println("IFSC Code of each memeber is :"+code[i]);
		}	
...
//		spec model no
		...
		for(int i=0; i<model.length;i++) {
			...
			System.out.println("Specs Model is :"+model[i]);
		}
		
//		App version
		System.out.println();
		String version[]= {"1.9.0","3.6.7","4.8.1","5.7.8","3.6.7","16.8.4",		
		                    "3.6.7","1.6.7","8.9.5","5.8.9"};
		...
		System.out.println();
				...
				for(int v=0;v<=passport.length-1;v++) {
					...
					System.out.println("The passport numbers are :"+passport[v]);
